            ...
            {estadoGps === "Activo" ?
                <td className="w-lg py-3 text-center justify-center transition-transform duration-500 hover:scale-110 sm:w-60">
                    <div className="flex justify-center">
                        <p className="bg-green-400 w-15 py-2 rounded-lg text-green-700 text-[12px] sm:text-[13px] self-center">{estadoGps}</p>
                    </div>

                </td> :
                <td className="w-lg py-3 text-center justify-center sm:w-60">
                    <div className="flex justify-center">
                        <p className="bg-red-300 text-red-700 w-15 py-2 rounded-lg text-[12px] sm:text-[13px]">{estadoGps}</p>
                    </div>
